...
class RevSliderAdmin extends RevSliderBaseAdmin{
	...
	public static function show_purchase_notice(){
		...
		if ('Lucille' == $current_theme->name || 'Lucille' == $current_theme->parent_theme) {
			return;
		}
	...
	public function addActivateNotification(){
		...
		<div class="updated below-h2 rs-update-notice-wrap" id="message">
			<a href="javascript:void(0);" style="float: right;padding-top: 9px;" id="rs-dismiss-notice">
			<?php 
			_e('(never show this message again)&nbsp;&nbsp;<b>X</b>','revslider'); 
			?>
			</a>
			<p>
			<?php
			_e('Hi! Would you like to activate your version of Revolution Slider to receive live updates & get premium support? This is optional and not needed if the slider came bundled with a theme. ','revslider'); 
			?>
			</p>
		</div>
